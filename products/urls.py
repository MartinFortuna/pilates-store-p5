...
urlpatterns = [
    ...
    path('update_product/<int:product_id>/', productViews.update_product, name='update_product'),
    path('delete/<int:product_id>/', productViews.delete_product, name='delete_product'),
]